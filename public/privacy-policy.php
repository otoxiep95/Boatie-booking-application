...
<main id="privacy" class="user-frontend">
    <!-- start section -->
    ...
    <div class="highlights user-section">
        <h2>Privacy Policy of Boatie</h2>
        <p>Boatie operates the http://boatie.dk website, which provides maritime rental services.</p>
        <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the boatie.dk website.</p>
        ...
        <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at http://boatie.dk, unless otherwise defined in this Privacy Policy.</p>
        ...
        <p>We want to inform our Service users that these third parties may have access to your Personal Information. The reason is to perform the tasks assigned to them on our behalf. However, they are obligated not to disclose or use the information for any other purpose.</p>
        <h2>Security</h2>
